"""
Django settings for wild_cake_42477 project.
...
ROOT_URLCONF = 'wild_cake_42477.urls'
...
WSGI_APPLICATION = 'wild_cake_42477.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wild_cake_42477 API",
    "DESCRIPTION": "API documentation for wild_cake_42477 App",
    "VERSION": "v1",
}
